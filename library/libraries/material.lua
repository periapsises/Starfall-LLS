...
--- gmodscreenspace.
--- Modulate_DX9.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L543).
...
--- Can't be modified.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L563).
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L483).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L463).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L493).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L431).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L503).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L439).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L447).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L513).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L420).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L523).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L533).
---@param path string # The path of the material (don't include .vmt in the path)
---@param key string # The key to get the vector from
---@return Vector? # The vector value or nil if it doesn't exist
...
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L455).
---@param path string # The path of the material (don't include .vmt in the path)
...
--- Can't be modified.
--- View [source](https://github.com/thegrb93/StarfallEx/blob/master/lua/starfall/libs_cl/material.lua#L406).
---@param path string # The path of the material (don't include .vmt in the path)
